...
const routes: Routes = [
  ...
  {
    path: 'linterna',
    loadChildren: () => import('./pages/linterna/linterna.module').then( m => m.LinternaPageModule)
  },
  {
    path: 'inicio',
    loadChildren: () => import('./pages/inicio/inicio.module').then( m => m.InicioPageModule)
  ...
  {
    path: 'colorear',
    loadChildren: () => import('./pages/colorear/colorear.module').then( m => m.ColorearPageModule)
  },
  {
    path: 'perfil',
